<form class="profile" method="post" enctype="multipart/form-data">
	...
	<div class="col-xs-12">
	  <div class="input-group">
	    ...
	    <input type="text" value="" name="pw" class="form-control">
	   
		<span class="input-group-addon">Confirm</span>
		<input type="text" value="" name="pw_confirm" class="form-control">
 
		<span class="input-group-addon">Email</span>
		<input type="text" value="" name="email" class="form-control">

		<span class="input-group-addon">Confirm</span>
		<input type="text" value="" name="email_confirm" class="form-control">
	  </div>
	</div>
	</div>
    </div>
