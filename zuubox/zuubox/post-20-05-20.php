...
<div class="window-btn window-btn2">
    ...
    <div class="post-left">
    	...
    	<div class="user-links">
	    	...
	    	<a class="" id="myFrdnew2">My Friends </a> 
	    	<a id="friend_request" class="">Friend Request </a> 
			<a id="bookmarkedId2" class="" style="line-height: 1.5;">Bookmark Users </a> 
			<a id="messagesdId2" class="">Messages </a> 
		</div>
		</div>
				...
				<div class="row">
					<div class="col-xs-8">
					   <div class="check">
							...
							<input type="checkbox" name="cellintrest" id="cellintrest" class="chk" onclick="checkintrest(this.value);" > Interest </div>
							<div>
				    ...
				    $("#percetage").change(function(){
		        		...
		        		var age_limit = $("#age_limit_post option:selected").val();
	                        ...
	                        $.ajax({
				        			...
				        			data:{age_limit:age_limit,percentage:percentage,cells:cells,searchfemale:searchfemale,searchmale:searchmale,searchcoworker:searchcoworker},
				        			success:function(result){
				        			//	alert(result);
				        			$("#usersearch").html(result);
				        			}
				    ...
				    $("#religion").change(function(){
		        		...
		        		var cells = '<?php echo $cellno; ?>';
	                        $.ajax({
				         			type:"POST",
				        			url:"post_searchajaxinterst.php",
				        			data:{age_limit:age_limit,religion:religion,cells:cells,searchfemale:searchfemale,searchmale:searchmale,searchcoworker:searchcoworker},
				        			success:function(result){
				        			//	alert(result);
				        			$("#usersearch").html(result);
				        			}
				    ...
				    $("#coworker").change(function(){
		        		...
		        		var cells = '<?php echo $cellno; ?>';
	                        $.ajax({
				         			type:"POST",
				        			url:"post_searchajaxinterst.php",
				        			data:{age_limit:age_limit,searchcoworker:coworker,cells:cells,searchfemale:searchfemale,searchmale:searchmale},
				        			success:function(result){
				        			//	alert(result);
				        			$("#usersearch").html(result);
				        			}
...
if ($('#searchageuser').prop("checked") == true)
		...
		else
		{
			...
			if ($('#lastloging').prop("checked") == true){
				...
				if($('#age_limit_post').prop("checked") == true){
				 ...
				 $.ajax({
	         				type:"POST",
	        				url:"post_searchajax.php",
	        				data:{lastlog:lastlog,searchmale:searchmale,searchfemale:searchfemale,searchreligion :searchreligion,age_limit:age_limit,searchcoworker:searchcoworker},
	        				success:function(result){
	        					//alert(result);
	        					//console.log(result);
		        				$("#usersearch").html(result);
...
function checkreligion(value){
	if($('#cellreligion').prop("checked") == true){
		...
		$('input:checkbox[name=searchageuser]').attr('checked',false);
	}
}
